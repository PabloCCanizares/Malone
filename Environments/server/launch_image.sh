...
echo "Executing with 2 workers\n"
time mpirun -np 2 -f Malone/machinefiles ./Malone/malone -a 4 -e img_heur_3.ini >> 
job_1_2_img_heur_3.txt
...
echo "Executing with 2 workers\n"
time mpirun -np 2 -f Malone/machinefiles ./Malone/malone -a 4 -e img_heur_4.ini >> 
job_1_2_img_heur_4.txt
