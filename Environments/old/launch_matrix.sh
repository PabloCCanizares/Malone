...
echo "Executing with 2 workers\n"
time mpirun -np 2 -f Malone/machinefiles ./Malone/malone -a 4 -e matrix_heur_3.ini >> job_0_2_matrix_heur_3.txt
...
echo "Executing with 2 workers\n"
time mpirun -np 2 -f Malone/machinefiles ./Malone/malone -a 4 -e matrix_heur_4.ini >> job_0_2_matrix_heur_4.txt
